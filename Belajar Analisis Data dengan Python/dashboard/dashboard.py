...
#  mengurutkan DataFrame berdasarkan order_date serta memastikan kedua kolom (order_date dan delivery_date) bertipe datetime
...
#  terkait parameter RFM (Recency, Frequency, & Monetary)
